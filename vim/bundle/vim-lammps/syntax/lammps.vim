...
syn keyword	lammpsOutput	log write_restart restart dump dump_modify undump thermo thermo_modify thermo_style print 
...
syn keyword	lammpsParticle	special_bonds
